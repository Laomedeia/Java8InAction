...
import juejin.netty.netty.protocol.packet.response.MessageFromUserResponsePacket;
...
public class MessageToUserRequestHandler extends SimpleChannelInboundHandler<MessageToUserRequestPacket> {
    ...
    public static final MessageToUserRequestHandler INSTANCE = new MessageToUserRequestHandler();

    private MessageToUserRequestHandler() {}
