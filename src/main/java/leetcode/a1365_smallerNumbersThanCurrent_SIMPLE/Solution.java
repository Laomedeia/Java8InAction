package leetcode.a1365_smallerNumbersThanCurrent_SIMPLE;
...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        int[] intArray = new int[]{8,1,2,2,3};
        solution.smallerNumbersThanCurrent(intArray);
    }
}
