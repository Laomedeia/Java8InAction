package leetcode.a315_countSmallerRightSide_HARD;
 ...
 *
 * @author neptune
 * @create 2020 07 11 2:38 下午
 */
public class Solution {

//    public List<Integer> countSmaller(int[] nums) {
//        List<Integer> listOrigin = Arrays.stream(nums).boxed().collect(Collectors.toList());
//        List<Integer> listChanged = Arrays.stream(nums).boxed().collect(Collectors.toList());
//    }
