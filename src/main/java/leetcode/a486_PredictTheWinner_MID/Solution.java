...
/**
 * 预测赢家
 * 给定一个表示分数的非负整数数组。 玩家 1 从数组任意一端拿取一个分数，随后玩家 2 继续从剩余数组任意一端拿取分数，然后玩家 1 拿，…… 。每次一个玩家只能拿取一个分数，分数被拿取之后不再可取。
...
//        int[] array = {1, 5, 2};
//        int[] array = {1, 5, 233, 7};
        int[] array = {2, 4, 55, 6, 8};
        boolean theWinner = solution.PredictTheWinner(array);
